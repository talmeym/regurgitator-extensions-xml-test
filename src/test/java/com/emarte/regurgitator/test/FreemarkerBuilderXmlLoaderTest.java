...
public class FreemarkerBuilderXmlLoaderTest extends XmlBaseTest {
	...
	public void testXml_source() throws Exception {
		assertExpectation(getElement("classpath:/FreemarkerBuilder_source.xml"), "com.emarte.regurgitator.extensions.FreemarkerBuilder:[com.emarte.regurgitator.core.ContextLocation:['context:location'],null]");
	}

	@Test
	public void testXml_value() throws Exception {
		assertExpectation(getElement("classpath:/FreemarkerBuilder_value.xml"), "com.emarte.regurgitator.extensions.FreemarkerBuilder:[null,'something something']");
	}

	@Test
	public void testXml_file() throws Exception {
		assertExpectation(getElement("classpath:/FreemarkerBuilder_file.xml"), "com.emarte.regurgitator.extensions.FreemarkerBuilder:[null,'something something']");
	}
